...
window.COVERLINE_PRODUCTS = [
  {
    ...
    desc: "A longline tee cut for shorter frames: long enough to cover the waistband of your leggings, and it stays down when you reach for the top shelf.",
  ...
  },
  {
    ...
    desc: "A covered-up set for petite frames: a boxy jacket that zips to the collar, and a jogger cut a touch shorter than standard so it sits on the shoe instead of pooling on it.",
  ...
  },
  {
    ...
    desc: "Loose everywhere on purpose: a collared shirt with contrast trim over a full-length wide-leg trouser, roomy enough to sit, walk and get in a car without anything pulling. The leg is full length, so on a petite frame you cuff it or wear a heel — the cuff looks planned.",
  ...
  },
  {
    ...
    desc: "A thick seamless knit you can bend over in, in daylight, with a high waistband that stays put when you sit. It runs small, so on a petite frame go one size up and it sits where it should.",
  ...
  },
  {
    ...
    desc: "Seamless and high-waisted, cut longer than the usual gym short so it covers the top of your thigh and stays put through a squat instead of creeping up between sets.",
