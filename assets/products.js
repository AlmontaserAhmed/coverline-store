...
window.COVERLINE_PRODUCTS = [
  ...
  },
  {
    ...
    colors: [
      { key: "black", label: "Black", hex: "#25272a", image: "/assets/product-images/legging-black.jpg?v=10" },
      { key: "nude", label: "Nude", hex: "#c9a888", image: "/assets/product-images/legging-nude.jpg?v=10" }
    ],
    image: "/assets/product-images/legging-black.jpg?v=10",
  ...
  },
  {
    ...
    colors: [
      { key: "maroon", label: "Maroon", hex: "#5b2430", image: "/assets/product-images/short-maroon.jpg?v=10" },
      { key: "pink", label: "Pink", hex: "#c79a9d", image: "/assets/product-images/short-pink.jpg?v=10" }
    ],
    image: "/assets/product-images/short-maroon.jpg?v=10",
