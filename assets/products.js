...
window.COVERLINE_PRODUCTS = [
  ...
  },
  {
    ...
    colors: [
      { key: "maroon", label: "Maroon", hex: "#5b2430", image: "/assets/product-images/short-maroon.jpg?v=18" },
      { key: "pink", label: "Pink", hex: "#c79a9d", image: "/assets/product-images/short-pink.jpg?v=18" }
    ],
    image: "/assets/product-images/short-maroon.jpg?v=18",
