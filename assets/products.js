...
window.COVERLINE_PRODUCTS = [
  {
    ...
    colors: [
      { key: "apricot", label: "Apricot", hex: "#dcb08c", image: "/assets/product-images/tee-apricot.jpg?v=37", images: ["/assets/product-images/tee-apricot.jpg?v=37", "/assets/product-images/tee-apricot-proof.jpg?v=37", "/assets/product-images/tee-apricot-back.jpg?v=37", "/assets/product-images/tee-apricot-detail.jpg?v=37"] },
      { key: "black", label: "Black", hex: "#25272a", image: "/assets/product-images/tee-black.jpg?v=37", images: ["/assets/product-images/tee-black.jpg?v=37", "/assets/product-images/tee-black-proof.jpg?v=37", "/assets/product-images/tee-black-back.jpg?v=37", "/assets/product-images/tee-black-detail.jpg?v=37"] }
    ],
    image: "/assets/product-images/tee-apricot.jpg?v=37",
  ...
  },
  {
    ...
    modelNote: "Model is 5'6\" and wears a size S.",
    colors: [
      { key: "cream", label: "Cream", hex: "#e6e0d4", image: "/assets/product-images/loungeset-cream.jpg?v=37", images: ["/assets/product-images/loungeset-cream.jpg?v=37", "/assets/product-images/loungeset-cream-proof.jpg?v=37", "/assets/product-images/loungeset-cream-back.jpg?v=37", "/assets/product-images/loungeset-cream-detail.jpg?v=37"] },
      { key: "navy", label: "Navy", hex: "#22283a", image: "/assets/product-images/loungeset-navy.jpg?v=37", images: ["/assets/product-images/loungeset-navy.jpg?v=37", "/assets/product-images/loungeset-navy-proof.jpg?v=37", "/assets/product-images/loungeset-navy-back.jpg?v=37", "/assets/product-images/loungeset-navy-detail.jpg?v=37"] }
    ],
    image: "/assets/product-images/loungeset-cream.jpg?v=37",
  ...
  },
  {
    ...
    colors: [
      { key: "black", label: "Black", hex: "#25272a", image: "/assets/product-images/coord-black.jpg?v=37", images: ["/assets/product-images/coord-black.jpg?v=37", "/assets/product-images/coord-black-proof.jpg?v=37", "/assets/product-images/coord-black-back.jpg?v=37", "/assets/product-images/coord-black-detail.jpg?v=37"] },
      { key: "oat", label: "Oat", hex: "#d9c9ad", image: "/assets/product-images/coord-oat.jpg?v=37", images: ["/assets/product-images/coord-oat.jpg?v=37", "/assets/product-images/coord-oat-proof.jpg?v=37", "/assets/product-images/coord-oat-back.jpg?v=37", "/assets/product-images/coord-oat-detail.jpg?v=37"] }
    ],
    image: "/assets/product-images/coord-black.jpg?v=37",
  ...
  },
  {
    ...
    colors: [
      { key: "black", label: "Black", hex: "#25272a", image: "/assets/product-images/legging-black.jpg?v=37", images: ["/assets/product-images/legging-black.jpg?v=37", "/assets/product-images/legging-black-proof.jpg?v=37", "/assets/product-images/legging-black-back.jpg?v=37", "/assets/product-images/legging-black-detail.jpg?v=37"] },
      { key: "nude", label: "Sand", hex: "#c9a888", image: "/assets/product-images/legging-nude.jpg?v=37", images: ["/assets/product-images/legging-nude.jpg?v=37", "/assets/product-images/legging-nude-proof.jpg?v=37", "/assets/product-images/legging-nude-back.jpg?v=37", "/assets/product-images/legging-nude-detail.jpg?v=37"] }
    ],
    image: "/assets/product-images/legging-black.jpg?v=37",
  ...
  },
  {
    ...
    modelNote: "Model is 5'3\" and wears a size S.",
    colors: [
      { key: "maroon", label: "Wine", hex: "#532d2e", image: "/assets/product-images/short-maroon.jpg?v=37", images: ["/assets/product-images/short-maroon.jpg?v=37", "/assets/product-images/short-maroon-proof.jpg?v=37", "/assets/product-images/short-maroon-back.jpg?v=37", "/assets/product-images/short-maroon-detail.jpg?v=37"] },
      { key: "pink", label: "Blush", hex: "#dcb9b6", image: "/assets/product-images/short-pink.jpg?v=37", images: ["/assets/product-images/short-pink.jpg?v=37", "/assets/product-images/short-pink-proof.jpg?v=37", "/assets/product-images/short-pink-back.jpg?v=37", "/assets/product-images/short-pink-detail.jpg?v=37"] }
    ],
    image: "/assets/product-images/short-maroon.jpg?v=37",
