...
window.COVERLINE_PRODUCTS = [
  {
    ...
    tagline: "Cut to length for a shorter frame.",
    desc: "A longline tee made for shorter proportions, so it ends at your hip rather than halfway down your thigh. Loose fit, but you're not swimming in it.",
    longDesc: "Longline usually means long on someone 5'9\", which on you turns into baggy and somewhere down your thigh. This one is drafted for a shorter body, so it's still long enough to wear over leggings or under a jacket, but it stops where a longline should. Loose through the body, nothing bunching at the waist.",
  ...
  },
  {
    ...
    desc: "A thick seamless knit with a high waistband that stays up when you sit. It's cut to Asian sizing, which runs small and shorter in the leg than a UK pair, so on a shorter frame it ends at the ankle instead of bunching over it. Go one size up from your usual.",
    longDesc: "For the days you live in leggings. Most pairs are drafted for a longer leg, so the spare fabric ends up gathered round your ankles. This one runs small and short, which is what a shorter frame wants: the waistband stays put when you sit and the leg ends where your leg does. Soft enough to sleep in, thick enough that you're not checking it in the mirror before you bend down. It's the pair you keep instead of rebuying the cheap ones every few months.",
